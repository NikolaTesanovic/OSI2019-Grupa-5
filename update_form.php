...
<body class="bg-light">
  ...
  <div class="py-5 text-center">
    ...
    <h2>Update form</h2>
    <p class="lead">Forma za azuriranje dogadjaja</p>
  </div>

    <div class="col-md-8 order-md-1">
      <h4 class="mb-3">Forma za azuriranje</h4>
              ...
              //sada dodamo u drop meni ostale gradove iz baze podataka
                ...
                if(mysqli_num_rows($result) > 0)
                {
                    while($row = mysqli_fetch_array($result))
                    {
                      ...
                      $result_grad_id = mysqli_query($DB, $query_grad);
            ...
            <?php
                ...
                if(mysqli_num_rows($result) > 0)
                {
                    while($row = mysqli_fetch_array($result))
                    {
                      ...
                      $result_kategorija_id = mysqli_query($DB, $query_kategorija);
